...
class CustomDataset(data_utl.Dataset):
    def __init__(self, video_path_list, label_list, cfg, transforms = None):
    ...
    def get_video(self, path):
        frames = []
        cap = cv2.VideoCapture(os.path.join(self.cfg['ROOT_PATH'], path))
